            ...
            <table className="w-full text-left border-collapse whitespace-nowrap">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  <th className="py-4 px-4 text-xs font-bold text-[#0B1220] uppercase tracking-wider">Staff Member</th>
                  <th className="py-4 px-4 text-xs font-bold text-[#0B1220] uppercase tracking-wider">Role / Dept</th>
                  <th className="py-4 px-4 text-xs font-bold text-[#0B1220] uppercase tracking-wider">Salary / Rate</th>
                  <th className="py-4 px-4 text-xs font-bold text-[#0B1220] uppercase tracking-wider">Pending Payout</th>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl overflow-x-auto">
                  <table className="w-full text-left min-w-[520px]">
                    <thead className="bg-slate-50 border-b border-slate-200">
                      <tr>
                        <th className="px-6 py-3 text-xs font-bold text-[#0B1220] uppercase">Month</th>
                        <th className="px-6 py-3 text-xs font-bold text-[#0B1220] uppercase">Amount</th>
                        <th className="px-6 py-3 text-xs font-bold text-[#0B1220] uppercase">Paid On</th>
                        {selectedStaff.systemRole === 'Typist' && (
                          <th className="px-6 py-3 text-xs font-bold text-[#0B1220] uppercase">Questions</th>
                        )}
                        <th className="px-6 py-3 text-xs font-bold text-[#0B1220] uppercase">Status</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
