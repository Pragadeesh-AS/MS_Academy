...
export default function AnimatedLogoutButton({ onLogout, isDark = false, className = '' }) {
  ...
  return (
    <button
      ref={buttonRef}
      className={`logoutButton ${isDark ? 'logoutButton--dark' : 'logoutButton--light'} ${className}`}
    >
