...
const TeacherCall = ({ appId, channel, token, handleEndMeet, sessionId, isChatOpen, toggleChat, chatToast, setChatToast, departmentQuestions, department }) => {
  ...
  return (
    <div className="flex-1 flex flex-col relative bg-black">
      ...
      <div
        className="absolute bottom-3 sm:bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-1.5 sm:gap-3 md:gap-6 px-2.5 sm:px-5 md:px-8 py-2 sm:py-3 md:py-4 rounded-full z-[100] transition-all duration-500 max-w-[calc(100vw-1rem)] overflow-x-auto no-scrollbar"
        style={{
